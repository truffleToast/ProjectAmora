			...
			<div class="gtco-container">
				<div class="row">
					<div class="topmargin">
					 ...
					 <form action ="Comwritee" method="post" >
						<div class="board_wrap">
							...
							<div class="board_list_wrap">
								...
								<div class="board_list">
									...
									<textarea name ="com_Title" style="height:40px; width: 840px; position: relative; bottom : 5px;" rows="1" cols="65 text-align: center;" placeholder=" 제목입력"></textarea>
									

									<div>
										<!-- <div style="width: 30px; height: 40px;"></div> -->
											<textarea name ="com_Content"rows="10" cols="65" placeholder=" 관리자의 판단하에 비방글은 삭제 됩니다."></textarea>
							...
							<div style ="position: relative; top:30px;left: 350px; " class="bt_wrap">
								...
								<a style=" border:3px solid #7297F7; font-color: black;"href="community.jsp">취소</a>
							</div>
						</div>
		         	</form>
					</div>

									...
									<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				                        ...
				                        BoardDAO dao = new BoardDAO();
											ArrayList<BoardDTO> list_Search = new ArrayList<>();
													if("title_content".equals(col)){list_Search = dao.getListFood_Search_Title_Content(sentence, pageNumber);}
													else if("content".equals(col)){list_Search =dao.getListFood_Search_Content(sentence, pageNumber);}
													else if("title".equals(col)){list_Search =dao.getListFood_Search_Title(sentence, pageNumber);}
													else if("writer".equals(col)){list_Search = dao.getListFood_Search_Writer(sentence, pageNumber);}
